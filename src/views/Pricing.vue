    ...
    <main>
      ...
      <div>
        <div class="relative bg-rose-600">
          ...
          <div
            class="relative mx-auto max-w-2xl px-4 pt-16 text-center sm:px-6 sm:pt-32 lg:max-w-7xl lg:px-8">
            <h1
                    ...
                    <div
                      ...
                      <dd
                        ...
                        <span
                          ...
                          >{{ feature.tiers[planIndex].value }}</span
                        >
                        <template v-else>
                          <CheckIcon
                    ...
                    <div
                      ...
                      <dd class="text-center sm:px-4">
                        ...
                        <XMarkIcon
                          ...
                          aria-hidden="true" />
                        <span class="sr-only">{{
                          perk.tiers[planIndex].value === true ? 'Yes' : 'No'
                        }}</span>
                      </dd>
                    </div>
                  </dl>
              ...
              <table class="relative w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                  <tr
                    ...
                    <td
                      v-for="(tier, index) in feature.tiers"
                      :key="tier.title"
                      :class="[
              ...
              <table class="relative w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                  <tr v-for="perk in perks" :key="perk.title">
                    ...
                    <td
                      v-for="(tier, index) in perk.tiers"
                      :key="tier.title"
                      :class="[
      ...
      <!-- Logo cloud -->
      <div
        class="mx-auto max-w-2xl py-12 px-4 sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8">
      ...
      <section aria-labelledby="faq-heading" class="bg-gray-900">
        <div
          ...
          <div class="mt-20">
            <dl
              class="space-y-10 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10 lg:space-y-0">
